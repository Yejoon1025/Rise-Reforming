    ...
    >
      ...
      <div className="absolute left-1/2 top-0 -translate-x-1/2 z-0">
        <AnimatePresence initial={false} mode="sync">
          ...
          {pg < 12 && (
            <motion.img key="bg3" ref={imgRef} src={bg3} alt="" {...imgCommon} />
          )}
          {pg < 16 && (
            <motion.img key="bg4" ref={imgRef} src={bg4} alt="" {...imgCommon} />
          )}
        </AnimatePresence>
      </div>
          ...
          >
            <GlowDotMobileProvider baseRef={imgRef} openStrategy="next" threshold={0.3}>
              <GlowDotMobile
                ...
                absY={dotY[8] * window.innerHeight}
                defaultOffsetX={-145}
                defaultOffsetY={-40}
                dotId="1"
                text={text.Home9}
          ...
          >
            <GlowDotMobileProvider baseRef={imgRef} openStrategy="next" threshold={0.3}>
              <GlowDotMobile
                ...
                absY={dotY[9] * window.innerHeight}
                defaultOffsetX={-145}
                defaultOffsetY={-40}
                dotId="1"
                text={text.Home10}
